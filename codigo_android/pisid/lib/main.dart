...
class LoginFormState extends State<LoginForm> {
  ...
  Widget build(BuildContext context) {
   ...
   validateLogin() async {
    ...
    // String loginURL = "http://localhost/scripts/validateLogin.php";
    // String loginURL = "http://192.168.1.184:80/scripts/validateLogin.php";
    // String loginURL = "http://127.0.0.1:3307/login.html";
    // String loginURL = "http://localhost/login.html";
    var response;
    ...
    try {
      ...
      response = await http.post(Uri.parse(loginURL), body: {
        ...
        // 'username': "el_investigador@email.com", //get the username text
        // 'password': "teste" //get password text
        // print("response: " + response);
      });
      //print("response: " + response);
    } catch (e) {
